  ...
  return (
    <View style={{ flex: 1 }} className='relative'>
      ...
      <KeyboardAvoidingView
        behavior='padding' // Ensure proper handling of keyboard interactions
      ...
      >
        ...
        <Input
          placeholder='Email'
          width='w-10/12'
          onClick={verifyEmail} // Ensure to use the correct prop for handling clicks
        />
        <Input
          placeholder='Contact Number'
          width='w-10/12'
          onClick={verifyNumber} // Ensure to use the correct prop for handling clicks
        />
        <Button
