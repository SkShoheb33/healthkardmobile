        ...
        <View style={ { flex: 1 } }>
            ...
            <ScrollView style={ { flexs: 1 } } className='w-full px-4'>
                <SafeAreaView style={ { flex: 1 } } className='w-full'>
                    ...
                    <View style={ styles.lightGreen } className='p-2 rounded-md'>
                        <View className='w-full flex-row items-center justify-between'>
                            <TimePicker placeHolder='From' width='w-5/12' onChange={ (value) => changeHandler('from', value) } value={ hospital.hospitalDetails.from } />
                            <TimePicker placeHolder='To' width='w-5/12' onChange={ (value) => changeHandler('to', value) } value={ hospital.hospitalDetails.to } />
                        </View>
                        ...
                        <Multiselect selectedItems={ hospital.hospitalDetails.servicesOffered } placeHolder='Services offered' list={ services } onChange={ changeHandler } />
                    </View>
